...
from src.models.efficientnet import last_conv_layer, load_checkpoint  # noqa: E402
...
def main() -> None:
    ...
    model, class_names = load_checkpoint(config.checkpoints_dir / "best_model.pt", device)
